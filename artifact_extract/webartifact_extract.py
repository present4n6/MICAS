...
def extract_artifact(argv, Userlist):
	...
	for user_inum, user in Userlist:
		...
		cache=file.getfileinfo(chrome_cache,dbname)
		chrome = file.get_fileinfo(chrome_history,dbname)
		edge = file.get_fileinfo(edge_history,dbname)
		ie = file.get_fileinfo(ie_history,dbname)
