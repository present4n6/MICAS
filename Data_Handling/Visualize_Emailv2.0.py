...
def Visualize():
    ...
    db= pymysql.connect(host='192.168.4.188', user='hadoopuser', password='Hadoopuser1!', db='Additional_email', charset='utf8')
    cur = db.cursor()
    ...
    try:
        ...
        pass
    plt.margins(x=1, y=1)
    plt.savefig("/home/hadoopuser/E-mail_Visualize" + ".png",bbox_inches='tight')
